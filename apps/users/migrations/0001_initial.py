    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department_id', models.CharField(choices=[(1, '研发部'), (2, '产品部'), (3, '测试部')], default=1, max_length=2, unique=True)),
            ],
            options={
                'db_table': 'department',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_group_id', models.CharField(choices=[(1, '查'), (2, '增查改'), (3, '增查改删')], max_length=2, unique=True)),
            ],
            options={
                'db_table': 'user_group',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.IntegerField(unique=True, verbose_name='手机号码')),
