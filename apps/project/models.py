...
class PostType(models.Model):
    """请求类型"""
    name = models.CharField(max_length=10, verbose_name="请求类型名称")
    class Meta:
        db_table= "post_type"
...
class InterfaceFiles(models.Model):
    """文档列表"""
    project=models.ForeignKey("ProjectList", to_field="id", on_delete=models.SET_DEFAULT, default=0, related_name="project_id", verbose_name="所属项目id",)
    create_user=models.ForeignKey("users.UserProfile", to_field="id", on_delete=models.SET_DEFAULT, default=0, related_name="user_id", verbose_name="创建用户")
    filesName=models.CharField(max_length=255, verbose_name="接口文档名称")
    post_methods=models.ForeignKey("PostMethods",to_field="id",on_delete=models.SET_DEFAULT,default=0,verbose_name="该接口请求方法id")
    post_type=models.ForeignKey("PostType",to_field="id",on_delete=models.SET_DEFAULT,default=0,verbose_name="该接口请求类型id")
    ...
    res_type=models.ForeignKey("ResType",to_field="id",on_delete=models.SET_DEFAULT,default=0,verbose_name="该接口返回方法id")
    create_time=models.DateTimeField(auto_now_add=True, verbose_name="创建时间")
